...
$Project = Join-Path $ProjectRoot "SonicChestFilters.csproj"
...
try {
    ...
    Copy-Item -LiteralPath $Dll -Destination (Join-Path $Dist "SonicChestFilters.dll") -Force
    Write-Host "DLL: $(Join-Path $Dist 'SonicChestFilters.dll')"
